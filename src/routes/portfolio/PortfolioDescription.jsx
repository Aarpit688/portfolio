  ...
  return (
    <section className="portfolio-content">
      ...
      <p className="white-text p-tag">
        ...
        few of my cherished endeavors that encapsulate my expertise. I've
        tackled numerous minor projects from diverse courses and challenges, all
        aimed at mastering the fundamentals. Feel free to explore these on my{" "}
        <span>
          <a
